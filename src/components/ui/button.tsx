  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[1.25rem] text-sm font-medium transition-all duration-300 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive cursor-pointer",
  {
    variants: {
      ...
      size: {
        ...
        sm: "h-9 rounded-[1rem] gap-1.5 px-4 has-[>svg]:px-3",
        lg: "h-11 rounded-[1.5rem] px-7 has-[>svg]:px-5",
        icon: "size-10 rounded-[1rem]",
        "icon-sm": "size-9 rounded-[0.875rem]",
        "icon-lg": "size-11 rounded-[1.25rem]",
      },
    },
    defaultVariants: {
      variant: "default",
